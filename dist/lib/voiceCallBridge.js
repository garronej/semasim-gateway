...
function fromDongle(channel) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const number = phone_number_1.phoneNumber.build(channel.request.callerid, !!dongle.sim.country ? dongle.sim.country.iso : undefined);
        let evtReachableContact = new ts_events_extended_1.SyncEvent();
        sipContactsMonitor.evtContactRegistration.attach(({ uaSim }) => uaSim.imsi === imsi, evtReachableContact, contact => evtReachableContact.post(contact));
        ...
        evtEstablishedOrEnded.attachOnce((contact) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!!contact) {
                ...
                yield dbSemasim.onCallAnswered(number, imsi, contact.uaSim.ua, ringingUas);
            }
            else {
                debug("Dongle channel hanged up but not answered");
                yield dbSemasim.onMissedCall(imsi, number);
            }
...
function fromSip(channel) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ami.evt.waitFor(e => (e["event"] === "RTCPSent" &&
            ...
            .then(() => dbSemasim.onTargetGsmRinging(contact, number, call_id)
