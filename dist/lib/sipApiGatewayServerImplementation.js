...
var handlers = {};
var server = new sipApi_1.protocol.Server(handlers);
...
(function () {
    var methodName = sipApi_1.gatewayDeclaration.reNotifySimOnline.methodName;
    handlers[methodName] = function (params, fromSocket) { return __awaiter(_this, void 0, void 0, function () {
        var imsi, dc, dongle;
        return __generator(this, function (_a) {
            imsi = params.imsi;
            dc = chan_dongle_extended_client_1.DongleController.getInstance();
            dongle = Array.from(dc.activeDongles.values())
                .find(function (_a) {
                var sim = _a.sim;
