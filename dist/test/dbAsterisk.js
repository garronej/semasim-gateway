...
const db = require("../lib/dbAsterisk");
...
function testDbAsterisk() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield db.launch();
        yield db.flush();
        const password = yield db.createEndpointIfNeededOptionallyReplacePasswordAndReturnPassword(contact.uaSim.imsi);
        ...
        console.assert(password
            ===
                (yield db.createEndpointIfNeededOptionallyReplacePasswordAndReturnPassword(contact.uaSim.imsi)));
        const newPassword = db.generateSipEndpointPassword();
        console.assert((yield db.createEndpointIfNeededOptionallyReplacePasswordAndReturnPassword(contact.uaSim.imsi, newPassword)) === newPassword);
        yield db.flush();
